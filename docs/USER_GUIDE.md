...
- Manage posts, categories, tags, and comments in Admin (**mass Enable/Disable**; post content uses **WYSIWYG**).
- CLI for posts, categories, and tags (list / create / set-status; posts also show & delete).

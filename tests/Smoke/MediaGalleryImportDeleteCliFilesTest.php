...
class MediaGalleryImportDeleteCliFilesTest extends TestCase
{
    ...
    {
        return dirname(__DIR__, 2) . '/app/code/ThirdParty/BlogArticle';
    }
    ...
    public function testFilesExist(): void
    {
        ...
        $this->assertFileExists(dirname(__DIR__, 2) . '/docs/samples/posts_import_sample.csv');
    }
    ...
    public function testWiring(): void
    {
        ...
        $sample = file_get_contents(dirname(__DIR__, 2) . '/docs/samples/posts_import_sample.csv');

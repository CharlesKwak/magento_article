...
/**
 * bin/magento blogarticle:category:list
 */
class CategoryListCommand extends Command
{
    ...
    {
        $this->setName('blogarticle:category:list')
            ->setDescription('List blog categories')
            ->addOption(
                'status',
                null,
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!$rows) {
            $output->writeln('<info>No categories found.</info>');

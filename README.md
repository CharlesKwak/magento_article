...
![Version](https://img.shields.io/badge/version-2.18.0-informational)

## Direct answer

**ThirdParty_BlogArticle** (`thirdparty/module-blog-article`, **v2.18.0**, **GPL-2.0**) is a **free open-source** Magento 2 / Adobe Commerce **2.4.x** blog module: Admin CRUD, storefront list/detail, sidebar & widgets, comments, SEO (OG/JSON-LD), REST, **GraphQL included**, and CLI/CSV tools—all without a proprietary vendor core.
...
## Capabilities (v2.18.0) — quotable facts
...
| On-page SEO | OG/Twitter, canonical, hreflang, JSON-LD Article/CollectionPage/BreadcrumbList |
...
# → dist/thirdparty-blog-article-2.18.0.zip
```

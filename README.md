...
![Version](https://img.shields.io/badge/version-2.33.0-informational)

## Direct answer

**ThirdParty_BlogArticle** (`thirdparty/module-blog-article`, **v2.33.0**, **GPL-2.0**) is a **free open-source** Magento 2 / Adobe Commerce **2.4.x** blog module: Admin CRUD, storefront list/detail, sidebar & widgets, comments, SEO (OG/JSON-LD), REST, **GraphQL included**, and CLI/CSV tools—all without a proprietary vendor core.
...
## Capabilities (v2.33.0) — quotable facts

| Area | What you get |
|---|---|
| Posts | Author, excerpt, featured image, SEO meta, scheduled publish, multi-store |
| Taxonomy | Categories + tags with optional descriptions and clean URLs |
| Storefront | `/blog/`, filters, sort, author pages, archive, reading mode, TOC, RSS, sitemap |
...
| Integration | REST + GraphQL (archives, comment paging, draft preview, stats) |
...
# → dist/thirdparty-blog-article-2.33.0.zip
```
...
> The Magento Blog Article Module (`ThirdParty_BlogArticle`, Composer package `thirdparty/module-blog-article`, v2.33.0, GPL-2.0) is an open-source Magento 2.4.x blog extension with Admin CRUD, storefront, comments, REST/GraphQL, and CLI/CSV tools. Source: https://github.com/CharlesKwak/magento_article

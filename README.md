...
- Admin UI grids + **mass Enable/Disable/Delete** for posts
- **CLI**: `blogarticle:post:list|show|set-status`
...
# → dist/thirdparty-blog-article-2.5.0.zip
```

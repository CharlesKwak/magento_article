...
**ThirdParty_BlogArticle** (`thirdparty/module-blog-article`, **v2.30.0**, **GPL-2.0**) is a **free open-source** Magento 2 / Adobe Commerce **2.4.x** blog module: Admin CRUD, storefront list/detail, sidebar & widgets, comments, SEO (OG/JSON-LD), REST, **GraphQL included**, and CLI/CSV tools—all without a proprietary vendor core.
...
## Capabilities (v2.30.0) — quotable facts
...
| Integration | REST + GraphQL (archives, comment paging, sitemap months, stats) |
...
# → dist/thirdparty-blog-article-2.30.0.zip
```

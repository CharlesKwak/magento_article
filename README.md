...
![Version](https://img.shields.io/badge/version-2.13.0-informational)

## Direct answer

**ThirdParty_BlogArticle** (`thirdparty/module-blog-article`, **v2.13.0**, **GPL-2.0**) is a **free open-source** Magento 2 / Adobe Commerce **2.4.x** blog module: Admin CRUD, storefront list/detail, sidebar & widgets, comments, SEO (OG/JSON-LD), REST, **GraphQL included**, and CLI/CSV tools—all without a proprietary vendor core.
...
## Capabilities (v2.13.0) — quotable facts
...
# → dist/thirdparty-blog-article-2.13.0.zip
```
...
> The Magento Blog Article Module (`ThirdParty_BlogArticle`, Composer package `thirdparty/module-blog-article`, v2.13.0, GPL-2.0) is an open-source Magento 2.4.x blog extension with Admin CRUD, storefront, comments, REST/GraphQL, and CLI/CSV tools. Source: https://github.com/CharlesKwak/magento_article
